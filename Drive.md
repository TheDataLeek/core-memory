# Google Drive — Master Directory

Links to key Drive locations. Add new entries as you reference them.

---

## Shared Drives / Top-Level Folders

| Name | Link | Notes |
|---|---|---|
| *(add your Drive roots here)* | | |

---

## By Project

*(When a project has associated Drive files, link the project node here for reference)*
